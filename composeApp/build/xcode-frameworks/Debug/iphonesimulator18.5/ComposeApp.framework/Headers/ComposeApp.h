...
- (instancetype)initWithCityName:(NSString *)cityName id:(int32_t)id temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature __attribute__((swift_name("init(cityName:id:temperature:weatherDescription:highTemperature:lowTemperature:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSavedWeatherItem *)doCopyCityName:(NSString *)cityName id:(int32_t)id temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature __attribute__((swift_name("doCopy(cityName:id:temperature:weatherDescription:highTemperature:lowTemperature:)")));
