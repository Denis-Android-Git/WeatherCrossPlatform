...
- (instancetype)initWithCityName:(NSString *)cityName id:(int32_t)id cityId:(ComposeAppInt * _Nullable)cityId temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature coordinates:(NSString *)coordinates __attribute__((swift_name("init(cityName:id:cityId:temperature:weatherDescription:highTemperature:lowTemperature:coordinates:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSavedWeatherItem *)doCopyCityName:(NSString *)cityName id:(int32_t)id cityId:(ComposeAppInt * _Nullable)cityId temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature coordinates:(NSString *)coordinates __attribute__((swift_name("doCopy(cityName:id:cityId:temperature:weatherDescription:highTemperature:lowTemperature:coordinates:)")));
...
- (instancetype)initWithCityId:(int32_t)cityId __attribute__((swift_name("init(cityId:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppMainScreenActionsSetCityId *)doCopyCityId:(int32_t)cityId __attribute__((swift_name("doCopy(cityId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t cityId __attribute__((swift_name("cityId")));
@end
