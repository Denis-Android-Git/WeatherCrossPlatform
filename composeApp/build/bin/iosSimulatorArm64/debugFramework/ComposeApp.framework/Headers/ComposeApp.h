...
- (ComposeAppWeatherDataBase *)initialize __attribute__((swift_name("initialize()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SavedWeatherItem")))
@interface ComposeAppSavedWeatherItem : ComposeAppBase
- (instancetype)initWithCityName:(NSString *)cityName cityId:(ComposeAppInt * _Nullable)cityId temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature coordinates:(NSString *)coordinates isCurrentLocation:(BOOL)isCurrentLocation __attribute__((swift_name("init(cityName:cityId:temperature:weatherDescription:highTemperature:lowTemperature:coordinates:isCurrentLocation:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSavedWeatherItem *)doCopyCityName:(NSString *)cityName cityId:(ComposeAppInt * _Nullable)cityId temperature:(double)temperature weatherDescription:(NSString *)weatherDescription highTemperature:(double)highTemperature lowTemperature:(double)lowTemperature coordinates:(NSString *)coordinates isCurrentLocation:(BOOL)isCurrentLocation __attribute__((swift_name("doCopy(cityName:cityId:temperature:weatherDescription:highTemperature:lowTemperature:coordinates:isCurrentLocation:)")));
...
@property (readonly) BOOL isCurrentLocation __attribute__((swift_name("isCurrentLocation")));
...
*/
- (void)clearCurrentLocationWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("clearCurrentLocation(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)upsertWeatherWeather:(ComposeAppSavedWeatherItem *)weather completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("upsertWeather(weather:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherDao_Impl")))
@interface ComposeAppWeatherDao_Impl : ComposeAppBase <ComposeAppWeatherDao>
...
@property (class, readonly, getter=companion) ComposeAppWeatherDao_ImplCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherDao_Impl.Companion")))
@interface ComposeAppWeatherDao_ImplCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppWeatherDao_ImplCompanion *shared __attribute__((swift_name("shared")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)useConnectionIsReadOnly:(BOOL)isReadOnly block:(id<ComposeAppKotlinSuspendFunction1>)block completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("useConnection(isReadOnly:block:completionHandler:)")));
...
__attribute__((swift_name("WeatherDataBase")))
@interface ComposeAppWeatherDataBase : ComposeAppRoom_runtimeRoomDatabase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<ComposeAppWeatherDao>)weatherDao __attribute__((swift_name("weatherDao()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherDataBase_Impl")))
@interface ComposeAppWeatherDataBase_Impl : ComposeAppWeatherDataBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSArray<ComposeAppRoom_runtimeMigration *> *)createAutoMigrationsAutoMigrationSpecs:(NSDictionary<id<ComposeAppKotlinKClass>, id<ComposeAppRoom_runtimeAutoMigrationSpec>> *)autoMigrationSpecs __attribute__((swift_name("createAutoMigrations(autoMigrationSpecs:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SystemLocale")))
@interface ComposeAppSystemLocale : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)getSystemLanguage __attribute__((swift_name("getSystemLanguage()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UrlConstant")))
@interface ComposeAppUrlConstant : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)urlConstant __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppUrlConstant *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *BASE_URL_IMAGES __attribute__((swift_name("BASE_URL_IMAGES")));
@property (readonly) NSString *BASE_URL_WEATHER __attribute__((swift_name("BASE_URL_WEATHER")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastDto")))
@interface ComposeAppForecastDto : ComposeAppBase
- (instancetype)initWithCurrent:(ComposeAppCurrent *)current forecast:(ComposeAppForecast *)forecast location:(ComposeAppLocation *)location __attribute__((swift_name("init(current:forecast:location:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppForecastDtoCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppForecastDto *)doCopyCurrent:(ComposeAppCurrent *)current forecast:(ComposeAppForecast *)forecast location:(ComposeAppLocation *)location __attribute__((swift_name("doCopy(current:forecast:location:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppCurrent *current __attribute__((swift_name("current")));
@property (readonly) ComposeAppForecast *forecast __attribute__((swift_name("forecast")));
@property (readonly) ComposeAppLocation *location __attribute__((swift_name("location")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForecastDto.Companion")))
@interface ComposeAppForecastDtoCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppForecastDtoCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImageListDto")))
@interface ComposeAppImageListDto : ComposeAppBase
- (instancetype)initWithResults:(NSArray<ComposeAppPhotoData *> *)results __attribute__((swift_name("init(results:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppImageListDtoCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppImageListDto *)doCopyResults:(NSArray<ComposeAppPhotoData *> *)results __attribute__((swift_name("doCopy(results:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<ComposeAppPhotoData *> *results __attribute__((swift_name("results")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImageListDto.Companion")))
@interface ComposeAppImageListDtoCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
...
- (instancetype)initWithHttpClient:(ComposeAppKtor_client_coreHttpClient *)httpClient systemLocale:(ComposeAppSystemLocale *)systemLocale __attribute__((swift_name("init(httpClient:systemLocale:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetScreenHeight")))
@interface ComposeAppGetScreenHeight : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)getScreenHeight __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppGetScreenHeight *shared __attribute__((swift_name("shared")));
@end
...
@property (class, readonly) ComposeAppNetworkError *badRequest __attribute__((swift_name("badRequest")));
@property (class, readonly) ComposeAppNetworkError *forbidden __attribute__((swift_name("forbidden")));
@property (class, readonly) ComposeAppNetworkError *notFound __attribute__((swift_name("notFound")));
@property (class, readonly) ComposeAppNetworkError *internalServerError __attribute__((swift_name("internalServerError")));
@property (class, readonly) ComposeAppNetworkError *serviceUnavailable __attribute__((swift_name("serviceUnavailable")));
@property (class, readonly) ComposeAppNetworkError *noInternetConnection __attribute__((swift_name("noInternetConnection")));
...
__attribute__((swift_name("MainScreenActions")))
@protocol ComposeAppMainScreenActions
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenActionsAddCity")))
@interface ComposeAppMainScreenActionsAddCity : ComposeAppBase <ComposeAppMainScreenActions>
- (instancetype)initWithCity:(ComposeAppSavedWeatherItem *)city __attribute__((swift_name("init(city:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppMainScreenActionsAddCity *)doCopyCity:(ComposeAppSavedWeatherItem *)city __attribute__((swift_name("doCopy(city:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppSavedWeatherItem *city __attribute__((swift_name("city")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenActionsGetWeatherByQuery")))
@interface ComposeAppMainScreenActionsGetWeatherByQuery : ComposeAppBase <ComposeAppMainScreenActions>
- (instancetype)initWithQuery:(NSString *)query __attribute__((swift_name("init(query:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppMainScreenActionsGetWeatherByQuery *)doCopyQuery:(NSString *)query __attribute__((swift_name("doCopy(query:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenActionsInit")))
@interface ComposeAppMainScreenActionsInit : ComposeAppBase <ComposeAppMainScreenActions>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)getInit __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppMainScreenActionsInit *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenActionsRefreshPosition")))
@interface ComposeAppMainScreenActionsRefreshPosition : ComposeAppBase <ComposeAppMainScreenActions>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)refreshPosition __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppMainScreenActionsRefreshPosition *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenActionsSetCityId")))
@interface ComposeAppMainScreenActionsSetCityId : ComposeAppBase <ComposeAppMainScreenActions>
- (instancetype)initWithCityId:(ComposeAppInt * _Nullable)cityId __attribute__((swift_name("init(cityId:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppMainScreenActionsSetCityId *)doCopyCityId:(ComposeAppInt * _Nullable)cityId __attribute__((swift_name("doCopy(cityId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppInt * _Nullable cityId __attribute__((swift_name("cityId")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchScreenActionsDeleteTempCityList")))
@interface ComposeAppSearchScreenActionsDeleteTempCityList : ComposeAppBase <ComposeAppSearchScreenActions>
- (instancetype)initWithTempList:(NSArray<ComposeAppSavedWeatherItem *> *)tempList __attribute__((swift_name("init(tempList:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSearchScreenActionsDeleteTempCityList *)doCopyTempList:(NSArray<ComposeAppSavedWeatherItem *> *)tempList __attribute__((swift_name("doCopy(tempList:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<ComposeAppSavedWeatherItem *> *tempList __attribute__((swift_name("tempList")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchScreenActionsSetTempList")))
@interface ComposeAppSearchScreenActionsSetTempList : ComposeAppBase <ComposeAppSearchScreenActions>
- (instancetype)initWithItem:(ComposeAppSavedWeatherItem * _Nullable)item __attribute__((swift_name("init(item:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSearchScreenActionsSetTempList *)doCopyItem:(ComposeAppSavedWeatherItem * _Nullable)item __attribute__((swift_name("doCopy(item:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppSavedWeatherItem * _Nullable item __attribute__((swift_name("item")));
@end
...
@interface ComposeAppAstro : ComposeAppBase
- (instancetype)initWithIsMoonUp:(int32_t)isMoonUp isSunUp:(int32_t)isSunUp moonIllumination:(int32_t)moonIllumination moonPhase:(NSString *)moonPhase moonrise:(NSString *)moonrise moonset:(NSString *)moonset sunrise:(NSString *)sunrise sunset:(NSString *)sunset __attribute__((swift_name("init(isMoonUp:isSunUp:moonIllumination:moonPhase:moonrise:moonset:sunrise:sunset:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppAstroCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppAstro *)doCopyIsMoonUp:(int32_t)isMoonUp isSunUp:(int32_t)isSunUp moonIllumination:(int32_t)moonIllumination moonPhase:(NSString *)moonPhase moonrise:(NSString *)moonrise moonset:(NSString *)moonset sunrise:(NSString *)sunrise sunset:(NSString *)sunset __attribute__((swift_name("doCopy(isMoonUp:isSunUp:moonIllumination:moonPhase:moonrise:moonset:sunrise:sunset:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="is_moon_up")
*/
@property (readonly) int32_t isMoonUp __attribute__((swift_name("isMoonUp")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="is_sun_up")
*/
@property (readonly) int32_t isSunUp __attribute__((swift_name("isSunUp")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="moon_illumination")
*/
@property (readonly) int32_t moonIllumination __attribute__((swift_name("moonIllumination")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="moon_phase")
*/
@property (readonly) NSString *moonPhase __attribute__((swift_name("moonPhase")));
@property (readonly) NSString *moonrise __attribute__((swift_name("moonrise")));
@property (readonly) NSString *moonset __attribute__((swift_name("moonset")));
...
@interface ComposeAppAstroCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppAstroCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface ComposeAppDay : ComposeAppBase
- (instancetype)initWithAvghumidity:(int32_t)avghumidity avgTempC:(double)avgTempC avgTempF:(double)avgTempF avgVisKm:(double)avgVisKm avgVisMiles:(double)avgVisMiles condition:(ComposeAppCondition *)condition dailyChanceOfRain:(int32_t)dailyChanceOfRain dailyChanceOfSnow:(int32_t)dailyChanceOfSnow dailyWillItRain:(int32_t)dailyWillItRain dailyWillItSnow:(int32_t)dailyWillItSnow maxTempC:(double)maxTempC maxTempF:(double)maxTempF maxWindKph:(double)maxWindKph maxWindMph:(double)maxWindMph minTempC:(double)minTempC minTempF:(double)minTempF totalPrecipIn:(double)totalPrecipIn totalPrecipMm:(double)totalPrecipMm totalSnowCm:(double)totalSnowCm uv:(double)uv __attribute__((swift_name("init(avghumidity:avgTempC:avgTempF:avgVisKm:avgVisMiles:condition:dailyChanceOfRain:dailyChanceOfSnow:dailyWillItRain:dailyWillItSnow:maxTempC:maxTempF:maxWindKph:maxWindMph:minTempC:minTempF:totalPrecipIn:totalPrecipMm:totalSnowCm:uv:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppDayCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppDay *)doCopyAvghumidity:(int32_t)avghumidity avgTempC:(double)avgTempC avgTempF:(double)avgTempF avgVisKm:(double)avgVisKm avgVisMiles:(double)avgVisMiles condition:(ComposeAppCondition *)condition dailyChanceOfRain:(int32_t)dailyChanceOfRain dailyChanceOfSnow:(int32_t)dailyChanceOfSnow dailyWillItRain:(int32_t)dailyWillItRain dailyWillItSnow:(int32_t)dailyWillItSnow maxTempC:(double)maxTempC maxTempF:(double)maxTempF maxWindKph:(double)maxWindKph maxWindMph:(double)maxWindMph minTempC:(double)minTempC minTempF:(double)minTempF totalPrecipIn:(double)totalPrecipIn totalPrecipMm:(double)totalPrecipMm totalSnowCm:(double)totalSnowCm uv:(double)uv __attribute__((swift_name("doCopy(avghumidity:avgTempC:avgTempF:avgVisKm:avgVisMiles:condition:dailyChanceOfRain:dailyChanceOfSnow:dailyWillItRain:dailyWillItSnow:maxTempC:maxTempF:maxWindKph:maxWindMph:minTempC:minTempF:totalPrecipIn:totalPrecipMm:totalSnowCm:uv:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="avgtemp_c")
*/
@property (readonly) double avgTempC __attribute__((swift_name("avgTempC")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="avgtemp_f")
*/
@property (readonly) double avgTempF __attribute__((swift_name("avgTempF")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="avgvis_km")
*/
@property (readonly) double avgVisKm __attribute__((swift_name("avgVisKm")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="avgvis_miles")
*/
@property (readonly) double avgVisMiles __attribute__((swift_name("avgVisMiles")));
@property (readonly) int32_t avghumidity __attribute__((swift_name("avghumidity")));
@property (readonly) ComposeAppCondition *condition __attribute__((swift_name("condition")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="daily_chance_of_rain")
*/
@property (readonly) int32_t dailyChanceOfRain __attribute__((swift_name("dailyChanceOfRain")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="daily_chance_of_snow")
*/
@property (readonly) int32_t dailyChanceOfSnow __attribute__((swift_name("dailyChanceOfSnow")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="daily_will_it_rain")
*/
@property (readonly) int32_t dailyWillItRain __attribute__((swift_name("dailyWillItRain")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="daily_will_it_snow")
*/
@property (readonly) int32_t dailyWillItSnow __attribute__((swift_name("dailyWillItSnow")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="maxtemp_c")
*/
@property (readonly) double maxTempC __attribute__((swift_name("maxTempC")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="maxtemp_f")
*/
@property (readonly) double maxTempF __attribute__((swift_name("maxTempF")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="maxwind_kph")
*/
@property (readonly) double maxWindKph __attribute__((swift_name("maxWindKph")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="maxwind_mph")
*/
@property (readonly) double maxWindMph __attribute__((swift_name("maxWindMph")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="mintemp_c")
*/
@property (readonly) double minTempC __attribute__((swift_name("minTempC")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="mintemp_f")
*/
@property (readonly) double minTempF __attribute__((swift_name("minTempF")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="totalprecip_in")
*/
@property (readonly) double totalPrecipIn __attribute__((swift_name("totalPrecipIn")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="totalprecip_mm")
*/
@property (readonly) double totalPrecipMm __attribute__((swift_name("totalPrecipMm")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="totalsnow_cm")
*/
@property (readonly) double totalSnowCm __attribute__((swift_name("totalSnowCm")));
@property (readonly) double uv __attribute__((swift_name("uv")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Day.Companion")))
@interface ComposeAppDayCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppDayCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface ComposeAppForecast : ComposeAppBase
- (instancetype)initWithForecastday:(NSArray<ComposeAppForecastday *> *)forecastday __attribute__((swift_name("init(forecastday:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppForecastCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppForecast *)doCopyForecastday:(NSArray<ComposeAppForecastday *> *)forecastday __attribute__((swift_name("doCopy(forecastday:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<ComposeAppForecastday *> *forecastday __attribute__((swift_name("forecastday")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Forecast.Companion")))
@interface ComposeAppForecastCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppForecastCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface ComposeAppForecastday : ComposeAppBase
- (instancetype)initWithAstro:(ComposeAppAstro *)astro date:(NSString *)date dateEpoch:(int32_t)dateEpoch day:(ComposeAppDay *)day hour:(NSArray<ComposeAppHour *> *)hour __attribute__((swift_name("init(astro:date:dateEpoch:day:hour:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppForecastdayCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppForecastday *)doCopyAstro:(ComposeAppAstro *)astro date:(NSString *)date dateEpoch:(int32_t)dateEpoch day:(ComposeAppDay *)day hour:(NSArray<ComposeAppHour *> *)hour __attribute__((swift_name("doCopy(astro:date:dateEpoch:day:hour:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppAstro *astro __attribute__((swift_name("astro")));
@property (readonly) NSString *date __attribute__((swift_name("date")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="date_epoch")
*/
@property (readonly) int32_t dateEpoch __attribute__((swift_name("dateEpoch")));
@property (readonly) ComposeAppDay *day __attribute__((swift_name("day")));
@property (readonly) NSArray<ComposeAppHour *> *hour __attribute__((swift_name("hour")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Forecastday.Companion")))
@interface ComposeAppForecastdayCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppForecastdayCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface ComposeAppHour : ComposeAppBase
- (instancetype)initWithChanceOfRain:(int32_t)chanceOfRain chanceOfSnow:(int32_t)chanceOfSnow cloud:(int32_t)cloud condition:(ComposeAppCondition *)condition dewPointC:(double)dewPointC dewPointF:(double)dewPointF feelsLikeC:(double)feelsLikeC feelsLikeF:(double)feelsLikeF gustKph:(double)gustKph gustMph:(double)gustMph heatIndexC:(double)heatIndexC heatIndexF:(double)heatIndexF humidity:(int32_t)humidity isDay:(int32_t)isDay precipIn:(double)precipIn precipMm:(double)precipMm pressureIn:(double)pressureIn pressureMb:(double)pressureMb snowCm:(double)snowCm tempC:(double)tempC tempF:(double)tempF time:(NSString *)time timeEpoch:(int32_t)timeEpoch uv:(double)uv visKm:(double)visKm visMiles:(double)visMiles willItRain:(int32_t)willItRain willItSnow:(int32_t)willItSnow windDegree:(int32_t)windDegree windDir:(NSString *)windDir windKph:(double)windKph windMph:(double)windMph windChillC:(double)windChillC windChillF:(double)windChillF __attribute__((swift_name("init(chanceOfRain:chanceOfSnow:cloud:condition:dewPointC:dewPointF:feelsLikeC:feelsLikeF:gustKph:gustMph:heatIndexC:heatIndexF:humidity:isDay:precipIn:precipMm:pressureIn:pressureMb:snowCm:tempC:tempF:time:timeEpoch:uv:visKm:visMiles:willItRain:willItSnow:windDegree:windDir:windKph:windMph:windChillC:windChillF:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppHourCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppHour *)doCopyChanceOfRain:(int32_t)chanceOfRain chanceOfSnow:(int32_t)chanceOfSnow cloud:(int32_t)cloud condition:(ComposeAppCondition *)condition dewPointC:(double)dewPointC dewPointF:(double)dewPointF feelsLikeC:(double)feelsLikeC feelsLikeF:(double)feelsLikeF gustKph:(double)gustKph gustMph:(double)gustMph heatIndexC:(double)heatIndexC heatIndexF:(double)heatIndexF humidity:(int32_t)humidity isDay:(int32_t)isDay precipIn:(double)precipIn precipMm:(double)precipMm pressureIn:(double)pressureIn pressureMb:(double)pressureMb snowCm:(double)snowCm tempC:(double)tempC tempF:(double)tempF time:(NSString *)time timeEpoch:(int32_t)timeEpoch uv:(double)uv visKm:(double)visKm visMiles:(double)visMiles willItRain:(int32_t)willItRain willItSnow:(int32_t)willItSnow windDegree:(int32_t)windDegree windDir:(NSString *)windDir windKph:(double)windKph windMph:(double)windMph windChillC:(double)windChillC windChillF:(double)windChillF __attribute__((swift_name("doCopy(chanceOfRain:chanceOfSnow:cloud:condition:dewPointC:dewPointF:feelsLikeC:feelsLikeF:gustKph:gustMph:heatIndexC:heatIndexF:humidity:isDay:precipIn:precipMm:pressureIn:pressureMb:snowCm:tempC:tempF:time:timeEpoch:uv:visKm:visMiles:willItRain:willItSnow:windDegree:windDir:windKph:windMph:windChillC:windChillF:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="chance_of_rain")
*/
@property (readonly) int32_t chanceOfRain __attribute__((swift_name("chanceOfRain")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="chance_of_snow")
*/
@property (readonly) int32_t chanceOfSnow __attribute__((swift_name("chanceOfSnow")));
@property (readonly) int32_t cloud __attribute__((swift_name("cloud")));
@property (readonly) ComposeAppCondition *condition __attribute__((swift_name("condition")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="snow_cm")
*/
@property (readonly) double snowCm __attribute__((swift_name("snowCm")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="time_epoch")
*/
@property (readonly) int32_t timeEpoch __attribute__((swift_name("timeEpoch")));
@property (readonly) double uv __attribute__((swift_name("uv")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="will_it_rain")
*/
@property (readonly) int32_t willItRain __attribute__((swift_name("willItRain")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="will_it_snow")
*/
@property (readonly) int32_t willItSnow __attribute__((swift_name("willItSnow")));
...
@interface ComposeAppHourCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppHourCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PhotoData")))
@interface ComposeAppPhotoData : ComposeAppBase
- (instancetype)initWithUrls:(ComposeAppUrls *)urls __attribute__((swift_name("init(urls:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppPhotoDataCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppPhotoData *)doCopyUrls:(ComposeAppUrls *)urls __attribute__((swift_name("doCopy(urls:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppUrls *urls __attribute__((swift_name("urls")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PhotoData.Companion")))
@interface ComposeAppPhotoDataCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppPhotoDataCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithCityId:(ComposeAppInt * _Nullable)cityId pageNumber:(ComposeAppInt * _Nullable)pageNumber __attribute__((swift_name("init(cityId:pageNumber:)"))) __attribute__((objc_designated_initializer));
...
- (ComposeAppRoutesMainScreenRoute *)doCopyCityId:(ComposeAppInt * _Nullable)cityId pageNumber:(ComposeAppInt * _Nullable)pageNumber __attribute__((swift_name("doCopy(cityId:pageNumber:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppInt * _Nullable cityId __attribute__((swift_name("cityId")));
@property (readonly) ComposeAppInt * _Nullable pageNumber __attribute__((swift_name("pageNumber")));
@end
...
- (instancetype)initWithPageNumber:(ComposeAppInt * _Nullable)pageNumber __attribute__((swift_name("init(pageNumber:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppRoutesSearchScreenRouteCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppRoutesSearchScreenRoute *)doCopyPageNumber:(ComposeAppInt * _Nullable)pageNumber __attribute__((swift_name("doCopy(pageNumber:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) ComposeAppInt * _Nullable pageNumber __attribute__((swift_name("pageNumber")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RoutesSearchScreenRoute.Companion")))
@interface ComposeAppRoutesSearchScreenRouteCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppRoutesSearchScreenRouteCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithSearchQuery:(NSString *)searchQuery expanded:(BOOL)expanded loading:(BOOL)loading cityList:(NSArray<ComposeAppLocation *> *)cityList error:(NSString * _Nullable)error tempListToDelete:(NSArray<ComposeAppSavedWeatherItem *> *)tempListToDelete __attribute__((swift_name("init(searchQuery:expanded:loading:cityList:error:tempListToDelete:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppSearchScreenViewState *)doCopySearchQuery:(NSString *)searchQuery expanded:(BOOL)expanded loading:(BOOL)loading cityList:(NSArray<ComposeAppLocation *> *)cityList error:(NSString * _Nullable)error tempListToDelete:(NSArray<ComposeAppSavedWeatherItem *> *)tempListToDelete __attribute__((swift_name("doCopy(searchQuery:expanded:loading:cityList:error:tempListToDelete:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSArray<ComposeAppSavedWeatherItem *> *tempListToDelete __attribute__((swift_name("tempListToDelete")));
@end
...
@interface ComposeAppUrls : ComposeAppBase
- (instancetype)initWithFull:(NSString *)full raw:(NSString *)raw regular:(NSString *)regular small:(NSString *)small smallS3:(NSString *)smallS3 thumb:(NSString *)thumb __attribute__((swift_name("init(full:raw:regular:small:smallS3:thumb:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) ComposeAppUrlsCompanion *companion __attribute__((swift_name("companion")));
- (ComposeAppUrls *)doCopyFull:(NSString *)full raw:(NSString *)raw regular:(NSString *)regular small:(NSString *)small smallS3:(NSString *)smallS3 thumb:(NSString *)thumb __attribute__((swift_name("doCopy(full:raw:regular:small:smallS3:thumb:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="small_s3")
*/
@property (readonly) NSString *smallS3 __attribute__((swift_name("smallS3")));
@property (readonly) NSString *thumb __attribute__((swift_name("thumb")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Urls.Companion")))
@interface ComposeAppUrlsCompanion : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppUrlsCompanion *shared __attribute__((swift_name("shared")));
- (id<ComposeAppKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (readonly) BOOL isAddCity __attribute__((swift_name("isAddCity")));
@property (readonly) BOOL isLoading __attribute__((swift_name("isLoading")));
@property (readonly) ComposeAppForecastDto * _Nullable weatherDto __attribute__((swift_name("weatherDto")));
@property (readonly) NSArray<ComposeAppWeatherItem *> *weatherItemList __attribute__((swift_name("weatherItemList")));
@end
...
@property BOOL isFirstLaunch __attribute__((swift_name("isFirstLaunch")));
...
- (instancetype)initWithViewModelScope:(id<ComposeAppKotlinx_coroutines_coreCoroutineScope>)viewModelScope __attribute__((swift_name("init(viewModelScope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithViewModelScope:(id<ComposeAppKotlinx_coroutines_coreCoroutineScope>)viewModelScope closeables:(ComposeAppKotlinArray<id<ComposeAppKotlinAutoCloseable>> *)closeables __attribute__((swift_name("init(viewModelScope:closeables:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (void)onActionActions:(id<ComposeAppMainScreenActions>)actions __attribute__((swift_name("onAction(actions:)")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreStateFlow> allCities __attribute__((swift_name("allCities")));
...
@interface ComposeAppKtor_client_coreHttpClient (Extensions)

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getImageRoute:(NSString *)route queryParams:(NSDictionary<NSString *, id> *)queryParams builder:(void (^)(ComposeAppKtor_client_coreHttpRequestBuilder *))builder completionHandler:(void (^)(id<ComposeAppResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getImage(route:queryParams:builder:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getWeatherRoute:(NSString *)route queryParams:(NSDictionary<NSString *, id> *)queryParams builder:(void (^)(ComposeAppKtor_client_coreHttpRequestBuilder *))builder completionHandler:(void (^)(id<ComposeAppResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getWeather(route:queryParams:builder:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpClientExtKt")))
@interface ComposeAppHttpClientExtKt : ComposeAppBase
+ (NSString *)constructRouteImageRoute:(NSString *)route __attribute__((swift_name("constructRouteImage(route:)")));
+ (NSString *)constructRouteWeatherRoute:(NSString *)route __attribute__((swift_name("constructRouteWeather(route:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)responseToResultResponse:(ComposeAppKtor_client_coreHttpResponse *)response completionHandler:(void (^)(id<ComposeAppResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("responseToResult(response:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)safeCallExecute:(id<ComposeAppKotlinSuspendFunction0>)execute completionHandler:(void (^)(id<ComposeAppResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("safeCall(execute:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpClientExt_nativeKt")))
@interface ComposeAppHttpClientExt_nativeKt : ComposeAppBase

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)platformSafeCallExecute:(id<ComposeAppKotlinSuspendFunction0>)execute handleResponse:(id<ComposeAppKotlinSuspendFunction1>)handleResponse completionHandler:(void (^)(id<ComposeAppResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("platformSafeCall(execute:handleResponse:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WeatherDataBaseKt")))
@interface ComposeAppWeatherDataBaseKt : ComposeAppBase
+ (ComposeAppWeatherDataBase *)getRoomDatabaseBuilder:(ComposeAppRoom_runtimeRoomDatabaseBuilder<ComposeAppWeatherDataBase *> *)builder __attribute__((swift_name("getRoomDatabase(builder:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPermissionStatePermission:(id<ComposeAppPermissionsPermission>)permission completionHandler:(void (^)(ComposeAppPermissionsPermissionState * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPermissionState(permission:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)isPermissionGrantedPermission:(id<ComposeAppPermissionsPermission>)permission completionHandler:(void (^)(ComposeAppBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("isPermissionGranted(permission:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)providePermissionPermission:(id<ComposeAppPermissionsPermission>)permission completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("providePermission(permission:completionHandler:)")));
@end
...
- (void)setKey:(ComposeAppKtor_utilsAttributeKey<id> *)key value:(id)value __attribute__((swift_name("set(key:value:)")));
...
@interface ComposeAppRoom_runtimeRoomDatabaseBuilder<T> : ComposeAppBase
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)addAutoMigrationSpecAutoMigrationSpec:(id<ComposeAppRoom_runtimeAutoMigrationSpec>)autoMigrationSpec __attribute__((swift_name("addAutoMigrationSpec(autoMigrationSpec:)")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)addCallbackCallback:(ComposeAppRoom_runtimeRoomDatabaseCallback *)callback __attribute__((swift_name("addCallback(callback:)")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)addMigrationsMigrations:(ComposeAppKotlinArray<ComposeAppRoom_runtimeMigration *> *)migrations __attribute__((swift_name("addMigrations(migrations:)")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)addTypeConverterTypeConverter:(id)typeConverter __attribute__((swift_name("addTypeConverter(typeConverter:)")));
- (T)build __attribute__((swift_name("build()")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)fallbackToDestructiveMigrationDropAllTables:(BOOL)dropAllTables __attribute__((swift_name("fallbackToDestructiveMigration(dropAllTables:)")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)fallbackToDestructiveMigrationFromDropAllTables:(BOOL)dropAllTables startVersions:(ComposeAppKotlinIntArray *)startVersions __attribute__((swift_name("fallbackToDestructiveMigrationFrom(dropAllTables:startVersions:)")));
- (ComposeAppRoom_runtimeRoomDatabaseBuilder<T> *)fallbackToDestructiveMigrationOnDowngradeDropAllTables:(BOOL)dropAllTables __attribute__((swift_name("fallbackToDestructiveMigrationOnDowngrade(dropAllTables:)")));
...
@protocol ComposeAppPermissionsPermission
@required
@property (readonly) id<ComposeAppPermissionsPermissionDelegate> delegate __attribute__((swift_name("delegate")));
@end
...
@interface ComposeAppRoom_runtimeRoomDatabaseCallback : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)onCreateConnection:(id<ComposeAppSqliteSQLiteConnection>)connection __attribute__((swift_name("onCreate(connection:)")));
- (void)onDestructiveMigrationConnection:(id<ComposeAppSqliteSQLiteConnection>)connection __attribute__((swift_name("onDestructiveMigration(connection:)")));
- (void)onOpenConnection:(id<ComposeAppSqliteSQLiteConnection>)connection __attribute__((swift_name("onOpen(connection:)")));
@end
...
@protocol ComposeAppSqliteSQLiteDriver
@required
- (id<ComposeAppSqliteSQLiteConnection>)openFileName:(NSString *)fileName __attribute__((swift_name("open(fileName:)")));
...
@interface ComposeAppRoom_runtimeRoomDatabaseJournalMode : ComposeAppKotlinEnum<ComposeAppRoom_runtimeRoomDatabaseJournalMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) ComposeAppRoom_runtimeRoomDatabaseJournalMode *truncate __attribute__((swift_name("truncate")));
@property (class, readonly) ComposeAppRoom_runtimeRoomDatabaseJournalMode *writeAheadLogging __attribute__((swift_name("writeAheadLogging")));
+ (ComposeAppKotlinArray<ComposeAppRoom_runtimeRoomDatabaseJournalMode *> *)values __attribute__((swift_name("values()")));
